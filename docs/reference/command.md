...
- [type ChatOption](<#ChatOption>)
  - [func WithModel\(name string\) ChatOption](<#WithModel>)
...
- [type ExecutionContext](<#ExecutionContext>)
  ...
  - [func \(ctx \*ExecutionContext\) LLM\(\) LLMProvider](<#ExecutionContext.LLM>)
...
- [type ManagerOption](<#ManagerOption>)
  - [func WithLLM\(llm LLMProvider\) ManagerOption](<#WithLLM>)
...
## func [WithExecutionContext](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L75>)
...
<a name="ChatOption"></a>
## type [ChatOption](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/llm.go#L11>)
...
<a name="WithModel"></a>
### func [WithModel](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/llm.go#L14>)
...
## type [ChatOptions](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/llm.go#L6-L8>)
...
## type [ExecutionContext](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L23-L33>)
...
### func [FromContext](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L80>)
...
### func \(\*ExecutionContext\) [ConversationKey](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L67>)
...
<a name="ExecutionContext.LLM"></a>
### func \(\*ExecutionContext\) [LLM](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L57>)
...
### func \(\*ExecutionContext\) [Responder](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L62>)
...
### func \(\*ExecutionContext\) [SetNoResponse](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L47>)
...
### func \(\*ExecutionContext\) [SetResponsePayload](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/context.go#L36>)
...
## type [LLMProvider](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/llm.go#L22-L28>)

LLMProvider 定义 Command 层依赖的 AI 能力接口。 这使得 Command 可以调用 AI 服务，而无需直接依赖 pkg/ai 包。
...
<a name="Manager"></a>
## type [Manager](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L16-L23>)
...
<a name="NewManager"></a>
### func [NewManager](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L50>)
...
### func \(\*Manager\) [Trigger](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L63>)
...
## type [ManagerOption](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L26>)
...
<a name="WithLLM"></a>
### func [WithLLM](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L36>)
...
<a name="WithLogger"></a>
### func [WithLogger](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L29>)
...
### func [WithResponder](<https://github.com/IMBotPlatform/IMBotCore/blob/main/pkg/command/manager.go#L43>)
